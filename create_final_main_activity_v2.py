...
# Replace the DynamicThemeKey import with all imports
content = content.replace(
    'import moe.koiverse.archivetune.constants.DynamicThemeKey',
    'import moe.koiverse.archivetune.constants.DynamicThemeKey' + imports_to_add
)

# Add the new preference variables after useSystemFont
preferences_to_add = '''
...
# Replace the existing LaunchedEffect with the new implementation
old_launched_effect = '''LaunchedEffect(playerConnection, enableDynamicTheme, isSystemInDarkTheme, customThemeColor) {
...
# Replace the old LaunchedEffect
